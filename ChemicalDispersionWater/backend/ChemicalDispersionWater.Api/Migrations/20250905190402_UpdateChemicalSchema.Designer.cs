...
namespace ChemicalDispersionWater.Api.Migrations
{
    ...
    [Migration("20250905190402_UpdateChemicalSchema")]
    partial class UpdateChemicalSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChemicalDispersionWater.SharedModels.Spill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2025, 9, 5, 19, 4, 2, 337, DateTimeKind.Utc).AddTicks(9238),
                            Volume = 1000.0
                        },
                        new
                        {
                            ...
                            Timestamp = new DateTime(2025, 9, 5, 18, 4, 2, 338, DateTimeKind.Utc).AddTicks(2031),
                            Volume = 500.0
                        });
                });
